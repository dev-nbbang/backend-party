...
public class FailDeleteParticipantException extends NbbangCommonException {
    private final String message;
    private final NbbangException nbbangException;

    public FailDeleteParticipantException(String message, NbbangException nbbangException) {
        super(message);
