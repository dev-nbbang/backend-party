...
public class FailDeletePaymentLogException extends NbbangCommonException {
    private final String message;
    private final NbbangException nbbangException;
    public FailDeletePaymentLogException(String message, NbbangException nbbangException) {
        super(message);
