...
public class NoCreateParticipantException extends NbbangCommonException {
    private final String message;
    private final NbbangException nbbangException;

    public NoCreateParticipantException(String message, NbbangException nbbangException) {
        super(message);
